        ...
        <div className="w-full h-full ">
          <div className="container mx-auto pt-10 ">
                ...
                <div className="flex flex-col md:flex-row justify-between ">
                  <div>
                    ...
                    <div className="mb-2 border-b border-neutral-700 pb-2 flex justify-between items-center">
                      ...
                      <Link href="/address" query={{ redirectTo: "/dashboard" }} className="underline">
                        {user.user.user_metadata.address ? "Edit" : "Add"}
                      </Link>
                    </div>
                    <div className="text-neutral-300 mb-4 md:mb-0">{user.user.user_metadata.address ? formatAddress(user.user.user_metadata.address) : "No address set"}</div>
                  </div>
                  ...
                  <div className="flex flex-col justify-between">
                    <div>
                      ...
                      <div className="text-neutral-300 mb-4 ">{!hasAccessCode ? (subscription.isSubscribed ? "Subscribed" : "Not Subscribed") : " Lifetime Access"}</div>
                    </div>
                    <div className="flex flex-col items-center">
                      {!hasAccessCode &&
                        (subscription.isSubscribed ? (
                          ...
                          <Link
                            href={user.user.user_metadata.address ? "/subscribe" : "/address"}
            ...
            <div className="bg-neutral-800 rounded-xl p-6 m-4 md:m-0">
              <div className={clsx([" flex justify-between items-center", isDownloadsOpen && "mb-4 border-b border-neutral-700 pb-2"])}>
                <h2 className="text-2xl font-bold text-neutral-300 ">Download Links</h2>
                <button onClick={handleToggleDownloadLinks} disabled={isDownloadLinksLoading}>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 text-neutral-200 hover:text-neutral-400">
              ...
              {isDownloadsOpen && (
                <>
                  ...
                  {downloadLinksError && <p className="text-neutral-300 mb-4">{downloadLinksError}</p>}
                  {(subscription && subscription.isSubscribed) || hasAccessCode ? (
                    ...
                    <p className="text-neutral-300 mb-4">You need to subscribe to download the application!</p>
                  )}
                </>
              )}
            </div>
