...
export default function VideoSection() {
  return (
    <div className="flex flex-col items-center w-full">
      <h2 className="text-xl md:text-3xl lg:text-5xl px-6 font-semibold bg-gradient-to-b from-white to-zinc-400 text-transparent bg-clip-text mt-12 sm:mt-24 p-1.5">Easy as 1, 2, 3...</h2>
      <div className="flex lg:flex-row flex-col-reverse justify-evenly xl:justify-between items-center lg:w-full xl:w-2/3 mt-12 sm:mt-24">
        ...
        <div className="flex items-center justify-center xl:p-24">
          <p className="text-5xl font-semibold mr-4">1</p>
          <p className="w-5/6 md:w-2/3 lg:w-1/3 xl:w-full text-start lg:mb-0 mb-12">Take a screenshot by pressing CTRL + ALT + SHFT + S on your keyboard.</p>
        </div>
      </div>
