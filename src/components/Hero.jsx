...
export default function Hero() {
  return (
    <div className="relative flex flex-col items-center z-20 min-h-screen w-full bg-[url(/mesh.png)] bg-center bg-no-repeat bg-[length:100%_100%]">
      ...
      <img src="/appss.png" alt="image of app interface" className="w-4/5 lg:w-3/5 h-auto mt-24 rounded-2xl shadow-2xl shadow-black/50" />
    </div>
  );
}
