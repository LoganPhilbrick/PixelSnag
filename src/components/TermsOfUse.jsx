function TermsOfUse() {
  return (
    <div className="w-full h-full bg-neutral-100 px-8 py-4">
      <style
      ...
      <div data-custom-class="body">
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <bdt className="question">Oregon</bdt>,{" "}
            ...
            at <bdt className="question">12014 SW Windmill Dr</bdt>
            <bdt className="block-component" />,{" "}
            <bdt className="question">Beaverton</bdt>
                ...
                <span style={{ fontSize: "15px" }}>
                  <span data-custom-class="body_text">
                    <span style={{ color: "rgb(89, 89, 89)" }}>
                      <bdt className="block-component" />
                      <bdt className="block-component" />,{" "}
                      <bdt className="question">OR</bdt>
                      <bdt className="statement-end-if-in-editor" />
                      <bdt className="block-component" />
                      <bdt className="block-component" />{" "}
                      <bdt className="question">97008</bdt>
                      <bdt className="statement-end-if-in-editor" />
                    </span>
                  </span>
                </span>
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            ...
            >
              ...
              phone at <bdt className="question">(+1)2159394137</bdt>, email at{" "}
              <bdt className="question">trevorphilbrick@pixelsnag.it.com</bdt>
              <bdt className="block-component" />,
              <bdt className="statement-end-if-in-editor" /> or by mail to{" "}
              <bdt className="question">12014 SW Windmill Dr</bdt>
              <bdt className="block-component" />,{" "}
              <bdt className="question">Beaverton</bdt>
              <bdt className="block-component" />
              <bdt className="block-component" />,{" "}
          ...
          >
            ...
            >
              ...
              <bdt className="statement-end-if-in-editor" />
              ), and <bdt className="question">PixelSnag</bdt>, concerning your
        ...
        >
          <strong>
            <span id="ip" style={{ fontSize: "19px", lineHeight: "1.5" }}>
        ...
        <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
          ...
          >
            <span style={{ fontSize: "15px" }}>
              ...
              <bdt className="block-component" />
              license
              <bdt className="statement-end-if-in-editor" /> to use such
              software solely in connection with our services and in accordance
              with these Legal Terms. Any software and any related documentation
              is provided <bdt className="block-component" />
              "AS IS"
              <bdt className="statement-end-if-in-editor" /> without warranty of
          ...
          >
            ...
            <strong>
              ...
              <span style={{ color: "rgb(0, 58, 250)" }}>
                ...
                >
                  <a
                    href="https://pixelsnag.it.com/privacy-policy"
                    target="_blank"
                    data-custom-class="link"
                  >
                    https://pixelsnag.it.com/privacy-policy
                  </a>
                </bdt>
              </span>
            </strong>
        ...
        >
          ...
          <bdt className="block-component" style={{ fontSize: "15px" }} />
          <span style={{ fontSize: "15px" }}>
          ...
          <bdt className="question" style={{ fontSize: "15px" }}>
            Oregon
          </bdt>
          <bdt
            className="statement-end-if-in-editor"
            ...
            <strong>
              <strong>
                ...
                >
                  <strong>
                    <bdt className="block-component" />
                    Phone: <bdt className="question">(+1)2159394137</bdt>
                    <bdt className="statement-end-if-in-editor" />
                  </strong>
                </span>
              </strong>
            ...
            >
              <strong>
                <bdt className="question">
                  <bdt className="block-component" />
                  <bdt className="question">
                    trevorphilbrick@pixelsnag.it.com
                  </bdt>
                  <bdt className="statement-end-if-in-editor" />
                </bdt>
              </strong>
