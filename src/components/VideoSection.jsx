...
export default function VideoSection() {
  return (
    <div className="flex flex-col items-center w-full">
      ...
      {/* <div className="flex lg:flex-row flex-col-reverse justify-evenly xl:justify-between items-center lg:px-12 lg:w-full xl:w-2/3 mt-12 sm:mt-24 bg-sky-500">
        <video autoPlay loop muted className="w-5/6 md:w-2/3 lg:w-1/2 rounded-xl">
          <source src="https://cgkethnnnnsxbzvglfmn.supabase.co/storage/v1/object/public/sample-videos//ss.mp4" type="video/mp4" />
          Your browser does not support the video tag.
        </video>
        <div className="flex items-center justify-center lg:pl-24 lg:mb-0 mb-12">
          <p className="text-5xl font-semibold mr-4">1</p>
          <p className="w-fit text-start">Take a screenshot by pressing CTRL + ALT + SHFT + S on your keyboard.</p>
        </div>
      </div> */}
      {/* <div className="flex lg:flex-row flex-col justify-evenly xl:justify-between items-center lg:w-full xl:w-2/3 mt-12 sm:mt-24">
        <div className="flex items-center justify-center xl:pr-24 lg:mb-0 mb-12">
          <p className="text-5xl font-semibold mr-4">2</p>
          <p className="w-5/6 md:w-2/3 lg:w-1/3 xl:w-full text-start">Take a screenshot by pressing CTRL + ALT + SHFT + S on your keyboard.</p>
        </div>
        <video autoPlay loop muted className="w-5/6 md:w-2/3 lg:w-1/2 rounded-xl">
      ...
      <div className="flex lg:flex-row flex-col-reverse justify-evenly xl:justify-between items-center lg:w-full xl:w-2/3 mt-12 sm:mt-24">
        ...
        <div className="flex items-center justify-center xl:pl-24 lg:mb-0 mb-12">
          <p className="text-5xl font-semibold mr-4">3</p>
          <p className="w-5/6 md:w-2/3 lg:w-1/3 xl:w-full text-start">Take a screenshot by pressing CTRL + ALT + SHFT + S on your keyboard.</p>
        </div> */}
      {/* </div> */}
