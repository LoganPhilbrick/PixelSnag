      ...
      {isOpen && (
        <div className="absolute top-0 left-0 w-full h-screen bg-neutral-900/50 backdrop-blur-sm">
          ...
          <div className="flex flex-col p-4 justify-center h-full gap-4">
            <Link
              href="/login"
              className="bg-black py-4 px-8 rounded-full hover:bg-neutral-900 transition-all duration-200 text-center"
            >
              Login
            </Link>
            <Link
              href="/signup"
              className="bg-white text-black py-4 px-8 rounded-full hover:bg-neutral-200 transition-all duration-200 text-center"
            >
              Signup
            </Link>
          </div>
